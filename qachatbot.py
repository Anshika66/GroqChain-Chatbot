...
A beginner - friendly version focussing on core concepts 
"""
...
## Page config 
st.set_page_config(page_title="Simple LangChain Chat with Groq" , page_icon="🚀")
...
with st.sidebar:
    ...
    if st.button("Clear Chat"):
        st.session_state.messages = []  # <-- fixed key
        st.rerun()
...
if not chain:
    ...
    if question := st.chat_input("Ask me anything"):
        ...
        st.session_state.messages.append({"role":"user","content":question})  # <-- fixed key
